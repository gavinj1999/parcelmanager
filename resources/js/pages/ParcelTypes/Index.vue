...
<AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-6">
        ...
        <table class="w-full mt-4 border">
            ...
            <tbody>
                <tr v-for="parceltype in parcelTypes" :key="type.id" class="border-t">
        ...
        <Modal :show="showAddModal" title="Add Parcel Type" @close="showAddModal = false">
            <form @submit.prevent="submitForm">
                ...
                <div class="mb-4">
                    ...
                    <select v-model="form.name" class="w-full border rounded p-2 bg-gray-800 text-gray-200" required>
        ...
        <Modal :show="showDeleteModal" title="Delete Parcel Type" @close="showDeleteModal = false">
            ...
            <div class="mt-4 flex justify-end">
                <button @click="deleteType" class="bg-red-600 hover:bg-red-700 text-gray-100 px-4 py-2 rounded mr-2">
                    Delete
                </button>
